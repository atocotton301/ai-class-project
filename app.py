...
# ------------------------------------------
# [STEP 1] 메인 랜딩 (로고) 및 로그인/회원가입 화면
# ------------------------------------------
if st.session_state.app_step == 'login_signup':
    
    # ✨ 예쁜 로고 및 타이틀 UI (HTML/CSS 적용)
    st.markdown("""
        <div style='text-align: center; padding: 2rem 0 1rem 0;'>
            <h1 style='font-size: 3.5rem; font-weight: 800; margin-bottom: 0; color: #1E88E5;'>
                📅 HanS-Plan AI
            </h1>
            <p style='font-size: 1.2rem; color: #666; margin-top: 5px;'>
                한성대 재학생을 위한 완벽한 비교과 스케줄러
            </p>
        </div>
...
# ------------------------------------------
    ...
    cert_mapping = {
        ...
        "크리에이티브인문학부": ["한국사능력검정시험", "관광통역안내사", "사서", "컴활 1/2급"],
        "예술학부 / 글로벌패션산업학부": ["GTQ", "컴퓨터그래픽스", "컬러리스트", "패션디자인"],
        "상상력인재학부 (자율전공)": ["컴활 1/2급", "MOS Master", "TOEIC / OPIc", "ITQ"]
    }
